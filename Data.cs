...
namespace Cycle_Race
{
    abstract class Data
    {
        ...
        public static string[] bettors = new string[3] { "Nick", "Nicolas", "Creamie" };          // Please change the names here according to your needs as these were only placeholder names
